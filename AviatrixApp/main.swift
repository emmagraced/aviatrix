...
func refuel(myPlane : Aviatrix) {
    ...
    print("Refueling...")
    print("⛽ Here in \(plane.location), jet fuel costs  \(myPlane.data.fuelPrices[plane.location]!)")
    print("⛽ You refueled \(plane.maxFuel - plane.fuelLevel) gallons totaling \(plane.maxFuel-plane.fuelLevel)/\(myPlane.data.fuelPrices[plane.location]!)")
}
...
var plane = Aviatrix(authorName: "emma & antonice")
